...
public abstract class CatDatabase extends RoomDatabase {
    ...
    //menginisialisasi nama database
    private static final String DATABASE_NAME = "Cat";

    //menginisialisasi variabel untuk mendapatkan gambar
    public abstract catimgDao catimgDao();

    //menginisialisasi kelas database
    ...
    // proses sinkronasi ke room database dengan API
